 ...
 */
public class MealGoalTagFlowLayout extends FlowLayout
        implements MealGoalTagAdapter.OnDataChangedListener {

    private MealGoalTagAdapter mTagAdapter;
    ...
    public MealGoalTagFlowLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public MealGoalTagFlowLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MealGoalTagFlowLayout(Context context) {
        this(context, null);
    }
    ...
    public void setAdapter(MealGoalTagAdapter adapter) {
        mTagAdapter = adapter;
    ...
    private void changeAdapter() {
        removeAllViews();
        MealGoalTagAdapter adapter = mTagAdapter;
    ...
    public MealGoalTagAdapter getAdapter() {
        return mTagAdapter;
    }
