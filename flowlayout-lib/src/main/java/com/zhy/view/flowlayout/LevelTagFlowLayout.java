...
/**
 * Created by mamta on 23/2/24.
 */
public class LevelTagFlowLayout extends FlowLayout implements LevelTagAdapter.OnDataChangedListener {

    private LevelTagAdapter mTagAdapter;
    ...
    public LevelTagFlowLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public LevelTagFlowLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LevelTagFlowLayout(Context context) {
        this(context, null);
    }
    ...
    public void setAdapter(LevelTagAdapter adapter) {
        mTagAdapter = adapter;
    ...
    private void changeAdapter() {
        removeAllViews();
        LevelTagAdapter adapter = mTagAdapter;
    ...
    public LevelTagAdapter getAdapter() {
        return mTagAdapter;
    }
