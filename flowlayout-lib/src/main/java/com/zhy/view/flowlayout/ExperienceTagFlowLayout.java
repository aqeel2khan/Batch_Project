 ...
 */
public class ExperienceTagFlowLayout extends FlowLayout
        implements ExperienceTagAdapter.OnDataChangedListener {

    private ExperienceTagAdapter mTagAdapter;
    ...
    public ExperienceTagFlowLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public ExperienceTagFlowLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ExperienceTagFlowLayout(Context context) {
        this(context, null);
    }
    ...
    public void setAdapter(ExperienceTagAdapter adapter) {
        mTagAdapter = adapter;
    ...
    private void changeAdapter() {
        removeAllViews();
        ExperienceTagAdapter adapter = mTagAdapter;
    ...
    public ExperienceTagAdapter getAdapter() {
        return mTagAdapter;
    }
