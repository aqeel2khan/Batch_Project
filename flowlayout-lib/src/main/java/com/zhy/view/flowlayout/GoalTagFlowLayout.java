 ...
 */
public class GoalTagFlowLayout extends FlowLayout
        implements GoalTagAdapter.OnDataChangedListener {

    private GoalTagAdapter mTagAdapter;
    ...
    public GoalTagFlowLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public GoalTagFlowLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GoalTagFlowLayout(Context context) {
        this(context, null);
    }
    ...
    public void setAdapter(GoalTagAdapter adapter) {
        mTagAdapter = adapter;
    ...
    private void changeAdapter() {
        removeAllViews();
        GoalTagAdapter adapter = mTagAdapter;
    ...
    public GoalTagAdapter getAdapter() {
        return mTagAdapter;
    }
