 ...
 */
public class CoachWtTagFlowLayout extends FlowLayout
        implements CoachWtTagAdapter.OnDataChangedListener {

    private CoachWtTagAdapter mTagAdapter;
    ...
    public CoachWtTagFlowLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public CoachWtTagFlowLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CoachWtTagFlowLayout(Context context) {
        this(context, null);
    }
    ...
    public void setAdapter(CoachWtTagAdapter adapter) {
        mTagAdapter = adapter;
    ...
    private void changeAdapter() {
        removeAllViews();
        CoachWtTagAdapter adapter = mTagAdapter;
    ...
    public CoachWtTagAdapter getAdapter() {
        return mTagAdapter;
    }
