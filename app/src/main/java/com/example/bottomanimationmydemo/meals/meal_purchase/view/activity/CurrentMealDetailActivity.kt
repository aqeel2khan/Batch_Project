...
import com.example.bottomanimationmydemo.adapter.ChosenMealListAdapter
...
//                        snackBarWithRedBackground(binding.root,errorBody(binding.root.context, it.errorBody, ""))
    ...
    private fun setupChosenMealList(days_dish:ArrayList<JSONObject>,days_category:ArrayList<String>) {
        binding.recyclerChosenMealList.apply {
            ...
            adapter = ChosenMealListAdapter(this@CurrentMealDetailActivity, days_dish,days_category, object : PositionItemClickListener<Int>{
     ...
     fun setDish(date:String){
         ...
         try {
             ...
             val jsonObject = JSONObject(item.toString())
                 ...
                 setupChosenMealList(dishArray,category_list);
